...
volatile unsigned long* const sub_Cycle_count = (void *)0x60015008;
...
unsigned long _sub_uptime() {
  // TODO [COD]
  //   You can use this function to assist to access performance counter related with time or cycle.
  return *(volatile unsigned long *)sub_Cycle_count;
}
