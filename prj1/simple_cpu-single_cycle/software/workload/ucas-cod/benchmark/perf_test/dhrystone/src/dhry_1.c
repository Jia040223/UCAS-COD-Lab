...
//  Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
  ...
  for (Run_Index = 1; Run_Index <= Number_Of_Runs; ++Run_Index)
  {
    ...
    {
      Int_3_Loc =mul( 5 , Int_1_Loc) - Int_2_Loc;
        /* Int_3_Loc == 7 */
                             ...
                             /* loop body executed twice */
    {
      ...
      /* Int_1_Loc == 3, Int_2_Loc == 3, Int_3_Loc == 7 */
    Int_2_Loc = mul(Int_2_Loc , Int_1_Loc);
    Int_1_Loc = div(Int_2_Loc , Int_3_Loc);
    Int_2_Loc = mul(7 , (Int_2_Loc - Int_3_Loc)) - Int_1_Loc;
  ...
  {
 #ifdef TIME
     Dhrystones_Per_Second = div(mul(1000000, Number_Of_Runs), User_Time);
 #else
     Dhrystones_Per_Second = div(mul(1000000,mul( HZ ,  Number_Of_Runs))
                             ,  User_Time);
 #endif
