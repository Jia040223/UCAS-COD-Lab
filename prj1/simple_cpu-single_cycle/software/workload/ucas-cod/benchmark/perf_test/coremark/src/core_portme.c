...
/* Define: TIMER_RES_DIVIDER
	...
	*/
	...
	#define MYTIMEDIFF(fin,ini) (div(((*(__int64*)&fin)-(*(__int64*)&ini)),TIMER_RES_DIVIDER))
	...
	#define MYTIMEDIFF(fin,ini) (mul((fin.tv_sec-ini.tv_sec),div(NSECS_PER_SEC,TIMER_RES_DIVIDER))+div((fin.tv_nsec-ini.tv_nsec),TIMER_RES_DIVIDER))
...
#endif
#define EE_TICKS_PER_SEC div(NSECS_PER_SEC , TIMER_RES_DIVIDER)
...
secs_ret time_in_secs(CORE_TICKS ticks) {
	secs_ret retval=div(((secs_ret)ticks) , (secs_ret)EE_TICKS_PER_SEC);
	return retval;
}
#else 
