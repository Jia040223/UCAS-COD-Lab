# add simple_cpu source HDL files
...
# add source HDL files of fixed components in simple_cpu 
add_files -norecurse -fileset sources_1 ${script_dir}/../design/${prj}/hardware/wrapper/simple_cpu/
...
# setup block design
set bd_design role
source ${script_dir}/../design/${prj}/fpga/wrapper/simple_cpu/${bd_design}.tcl
